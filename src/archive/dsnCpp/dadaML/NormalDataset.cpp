...
void NormalDataset::GenerateSamples(int N, int D, double *a, double *mu, int seed, vector< vector<float> > &samples)
{
	 double *x = multinormal_sample ( D, N, a, mu, &seed );
	 samples.resize(N);
	 for(unsigned int i=0; i< N; i++) {
		 samples[i].clear();
		 for(unsigned int j=0; j< D; j++) {
			 samples[i].push_back( (float) x[ i*D + j] ); 
		 }
	 }
	 delete [] x;
}
...
int NormalDataset::i4_max ( int i1, int i2 )
...
int NormalDataset::i4_min ( int i1, int i2 )
...
double * NormalDataset::multinormal_sample ( int m, int n, double a[], double mu[], int *seed )
...
double NormalDataset::r8_uniform_01 ( int *seed )
...
void NormalDataset::r8mat_print ( int m, int n, double a[], string title )
...
void NormalDataset::r8mat_print_some ( int m, int n, double a[], int ilo, int jlo, int ihi, 
...
void NormalDataset::r8mat_write ( string output_filename, int m, int n, double table[] )
...
double * NormalDataset::r8po_fa ( int n, double a[] )
...
double * NormalDataset::r8vec_normal_01_new ( int n, int *seed )
...
void NormalDataset::r8vec_print ( int n, double a[], string title )
...
double * NormalDataset::r8vec_uniform_01_new ( int n, int *seed )
