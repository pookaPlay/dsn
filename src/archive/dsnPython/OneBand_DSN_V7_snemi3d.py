...
if __name__ == '__main__':
    ...
    for cepoch in range(0,numEpochs):
        ...
        # Saving loss and rerror per epoch
        ...
        if trn_cepoch_rerror < trn_best_rerror:
            ...
            print("Current best training error", str(trn_best_rerror))
            torch.save(trn_best_rerror_model.state_dict(), "best_trn_error_model.pth")
        ...
        for val_idx in range(0, len(val_img_paths)):
            ...
            #print("\t Validating on ",str(val_img_path)," image")
            # Validation image
        ...
        if val_cepoch_loss < val_best_loss:
            ...
            torch.save(val_best_loss_model.state_dict(), "best_val_model.pth")
        ...
        if val_cepoch_rerror < val_best_rerror:
            ...
            print("Current best validation error", str(val_best_rerror))
            torch.save(val_best_rerror_model.state_dict(), "best_rerror_model.pth")
