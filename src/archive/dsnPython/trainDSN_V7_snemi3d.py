...
if __name__ == '__main__':
    ...
    model = UNet(in_channels=1, n_classes=1, depth=5, padding=True, up_mode='upsample').to(device)
    ...
    val_img_paths = get_valid_img_paths(trn_img_path, num_stacks)
    ...
    for cepoch in range(0,numEpochs):
        ...
        for trn_idx in range(0, len(trn_img_paths)):
            ...
            img1_r, seg1_r = apply_rotation(img1_o, seg1_o)

            # With 1/2 chance choose to flip image left to right
            img1, seg1 = apply_horizontal_flip(img1_r, seg1_r)
