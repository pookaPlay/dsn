...
if __name__ == '__main__':
    ...
    for val_idx in range(0, len(val_img_paths)):
        ...
        img1      = img1e_o[0:128, 0:128]
        
        seg1      = skio.imread(val_seg_path)
        seg1t      = seg1[0:128, 0:128]
        seg1      = FixZeroLabels(seg1t)
...
##Baseline
#Traning rand:  0.05953236512195378, 0.05679324828304302
#Validation rand:  0.05679324828304302, 0.05953236512195378
